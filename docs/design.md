...
```
ghs plan  [-s .github/settings.yml] [-R owner/repo] [--format text|markdown|json] [--exit-code] [--allow-unknown]
ghs apply [-s .github/settings.yml] [-R owner/repo] [--allow-unknown]
```
